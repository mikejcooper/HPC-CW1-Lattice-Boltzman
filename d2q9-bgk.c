...
// ----------------END--------------------------------------------
      else 
      {
        ...
        cells[index].speeds[0] = tmp_cells[index].speeds[0]
                                                  + params.omega 
                                                  * (16.0 * local_density * d1 * (1.0 - (u_x * u_x + u_y * u_y) * 54 * d1)
                                                    - tmp_cells[index].speeds[0]);
        cells[index].speeds[1] = tmp_cells[index].speeds[1]
                                                  + params.omega
                                                  * (local_density * 4.0 * d1 * (1.0 + u_x * 3.0 + (u_x * u_x) * 0.5 * 9.0 - (54 * d1 * (u_x * u_x + u_y * u_y)))
                                                    - tmp_cells[index].speeds[1]);
        cells[index].speeds[2] = tmp_cells[index].speeds[2]
                                                  + params.omega
                                                  * (local_density * 4.0 * d1 * (1.0 + u_y * 3.0 + (u_y * u_y) * 0.5 * 9.0 - (54 * d1 * (u_x * u_x + u_y * u_y)))
        ...
        cells[index].speeds[5] = tmp_cells[index].speeds[5]
                                                  + params.omega
                                                  * (local_density * d1 * (1.0 + (u_x + u_y) * 3.0 + ((u_x + u_y) * (u_x + u_y)) * 0.5 * 9.0 - (54 * d1 * (u_x * u_x + u_y * u_y)))
                                                    - tmp_cells[index].speeds[5]);
